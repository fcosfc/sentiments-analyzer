...
import stylesCss from 'themes/sentimentsanalyzer/styles.css';
...
export const applyTheme = (target) => {
  ...
  if (!document['_vaadintheme_sentimentsanalyzer_componentCss']) {
    
    document['_vaadintheme_sentimentsanalyzer_componentCss'] = true;
  }
