 ...
 */
@PWA(name = "Sentiments analyzer", shortName = "Sentiments analyzer", enableInstallPrompt = false)
@Theme(themeFolder = "sentimentsanalyzer")
@PageTitle("Main")
public class MainLayout extends AppLayout {
    ...
    private Component createDrawerContent() {
        H2 appName = new H2("Sentiments analyzer");
